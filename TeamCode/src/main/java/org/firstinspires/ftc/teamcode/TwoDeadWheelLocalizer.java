...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -9198.4820063442; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -4236.4234061151; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public Twist2dDual<Time> update() {
        ...
        FlightRecorder.write("TWO_DEAD_WHEEL_INPUTS", new org.firstinspires.ftc.teamcode.TwoDeadWheelInputsMessage(parPosVel, perpPosVel, angles, angularVelocity));
