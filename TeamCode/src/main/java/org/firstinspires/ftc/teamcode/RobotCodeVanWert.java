...
@TeleOp
public class RobotCodeVanWert extends LinearOpMode {


    TransferServo Servo = new TransferServo(hardwareMap);
    private DcMotor FrontRight;
    private DcMotor BackRight;
    private DcMotor FrontLeft;
    private DcMotor BackLeft;
    double forward, strafe, rotate;
    IntakeTest bench = new IntakeTest();
    boolean motorspeed = false;
    Outtake Bench1 = new Outtake();
